...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{diagram/use case diagram GUEST.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{diagram/use case diagram USER.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{diagram/use case diagram ADMIN.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{diagram/high_level_architecture.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{diagram/erd diagram.jpg}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{diagram/Authentication Flow sequence diagram.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{diagram/Shopping & Checkout Flow sequence diagram.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{diagram/Admin Product Management sequence diagram.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{diagram/AI Chatbot Flow sequence diagram.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{diagram/Payment activitis.png}
...
\section{System Interface Results}

This section presents the visual results of the implemented system, demonstrating the user interface design, responsive layout, and key functional workflows.

\subsection{General User Interface}

\begin{figure}[H]
    \centering
    % \includegraphics[width=\linewidth]{images/screenshots/homepage_desktop.png}
    \fbox{\begin{minipage}[c][10cm]{\linewidth}\centering \Large PLACEHOLDER: Homepage Desktop Screenshot\\\small (Save file as: images/screenshots/homepage\_desktop.png)\end{minipage}}
    \caption{System Homepage (Desktop View) showcasing the Hero section and 3D Product Visualization.}
    \label{fig:homepage_desktop}
\end{figure}

\begin{figure}[H]
    \centering
    % \includegraphics[width=0.6\linewidth]{images/screenshots/homepage_mobile.png}
    \fbox{\begin{minipage}[c][12cm]{0.6\linewidth}\centering \Large PLACEHOLDER: Homepage Mobile View\\\small (Save file as: images/screenshots/homepage\_mobile.png)\end{minipage}}
    \caption{Responsive Mobile Layout of the Homepage.}
    \label{fig:homepage_mobile}
\end{figure}

\subsection{Product Category Pages}

The system features dedicated pages for each major product line, providing specialized filtering and display options.

\begin{figure}[H]
    \centering
    % \includegraphics[width=\linewidth]{images/screenshots/iphone_page.png}
    \fbox{\begin{minipage}[c][10cm]{\linewidth}\centering \Large PLACEHOLDER: iPhone Category Page\\\small (Save file as: images/screenshots/iphone\_page.png)\end{minipage}}
    \caption{iPhone Product Category Page.}
    \label{fig:iphone_page}
\end{figure}

\begin{figure}[H]
    \centering
    % \includegraphics[width=\linewidth]{images/screenshots/ipad_page.png}
    \fbox{\begin{minipage}[c][10cm]{\linewidth}\centering \Large PLACEHOLDER: iPad Category Page\\\small (Save file as: images/screenshots/ipad\_page.png)\end{minipage}}
    \caption{iPad Product Category Page.}
    \label{fig:ipad_page}
\end{figure}

\begin{figure}[H]
    \centering
    % \includegraphics[width=\linewidth]{images/screenshots/mac_page.png}
    \fbox{\begin{minipage}[c][10cm]{\linewidth}\centering \Large PLACEHOLDER: Mac Category Page\\\small (Save file as: images/screenshots/mac\_page.png)\end{minipage}}
    \caption{Mac Product Category Page.}
    \label{fig:mac_page}
\end{figure}

\begin{figure}[H]
    \centering
    % \includegraphics[width=\linewidth]{images/screenshots/watch_page.png}
    \fbox{\begin{minipage}[c][10cm]{\linewidth}\centering \Large PLACEHOLDER: Apple Watch Category Page\\\small (Save file as: images/screenshots/watch\_page.png)\end{minipage}}
    \caption{Apple Watch Product Category Page.}
    \label{fig:watch_page}
\end{figure}

\begin{figure}[H]
    \centering
    % \includegraphics[width=\linewidth]{images/screenshots/airpods_page.png}
    \fbox{\begin{minipage}[c][10cm]{\linewidth}\centering \Large PLACEHOLDER: AirPods \& Accessories Page\\\small (Save file as: images/screenshots/airpods\_page.png)\end{minipage}}
    \caption{AirPods and Accessories Category Page.}
    \label{fig:airpods_page}
\end{figure}

\subsection{Product Details and Interaction}

\begin{figure}[H]
    \centering
    % \includegraphics[width=\linewidth]{images/screenshots/product_detail_3d.png}
    \fbox{\begin{minipage}[c][10cm]{\linewidth}\centering \Large PLACEHOLDER: Product Detail Page with 3D Model\\\small (Save file as: images/screenshots/product\_detail\_3d.png)\end{minipage}}
    \caption{Product Detail Page featuring interactive 3D model viewer.}
    \label{fig:product_detail}
\end{figure}

% Section 5.3.3 removed.

\subsection{User Dashboard}

\begin{figure}[H]
    \centering
    % \includegraphics[width=\linewidth]{images/screenshots/user_dashboard.png}
    \fbox{\begin{minipage}[c][10cm]{\linewidth}\centering \Large PLACEHOLDER: User Dashboard\\\small (Save file as: images/screenshots/user\_dashboard.png)\end{minipage}}
    \caption{User Dashboard displaying order history, loyalty rank, and voucher wallet.}
    \label{fig:dashboard}
\end{figure}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.6\linewidth]{images/screenshots/chatbot_interaction.png}
    \fbox{\begin{minipage}[c][12cm]{0.6\linewidth}\centering \Large PLACEHOLDER: Chatbot Interaction\\\small (Save file as: images/screenshots/chatbot\_interaction.png)\end{minipage}}
    \caption{AI Chatbot answering product questions using Google Gemini API.}
    \label{fig:chatbot}
\end{figure}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=\linewidth]{images/screenshots/admin_dashboard.png}
    \fbox{\begin{minipage}[c][10cm]{\linewidth}\centering \Large PLACEHOLDER: Admin Dashboard Overview\\\small (Save file as: images/screenshots/admin\_dashboard.png)\end{minipage}}
    \caption{Admin Dashboard with real-time sales analytics and inventory warnings.}
    \label{fig:admin_dashboard}
\end{figure}

\begin{figure}[H]
    \centering
    % \includegraphics[width=\linewidth]{images/screenshots/admin_products.png}
    \fbox{\begin{minipage}[c][10cm]{\linewidth}\centering \Large PLACEHOLDER: Product Management Interface\\\small (Save file as: images/screenshots/admin\_products.png)\end{minipage}}
    \caption{Admin Interface for Product Management (CRUD operations).}
    \label{fig:admin_products}
\end{figure}

% Section 5.4 Deployment Process removed.

% Section 5.5 Summary removed.
...
\begin{itemize}
    \item Requirements traceability (Functional Requirements in Chapter 3 $\rightarrow$ implementation evidence with code references in Chapter 5)
    \item Comprehensive UML diagrams: Use Case Diagrams for three actor roles (Figures~\ref{fig:usecase_guest}, ~\ref{fig:usecase_customer}, ~\ref{fig:usecase_admin}), Entity-Relationship Diagram (Figure~\ref{fig:erd}), sequence diagrams for key workflows (Figures~\ref{fig:jwt_flow}, ~\ref{fig:shopping_checkout}, ~\ref{fig:admin_sequence}, ~\ref{fig:ai_chatbot}), and activity diagram for payment processing (Figure~\ref{fig:payment_activity}), all aligned with IEEE 1471 architectural description standard
    \item Quantitative evaluation methodology (Apache JMeter load testing with statistical analysis, SUS usability scoring with participant demographics)
    \item Future work roadmap (Section 7.3) demonstrating intellectual honesty
\end{itemize}

These practices, often absent in undergraduate projects, elevate this work to a **graduate-level standard** suitable for publication in academic conferences or technical journals.
...
\subsection{Priority Enhancements}

\begin{enumerate}
    \item \textbf{Automated Testing:} Implement Jest unit tests for critical API endpoints (authentication, checkout) and Selenium E2E tests for user workflows. This addresses the manual testing bottleneck identified in Section 7.3.5.
    
    \item \textbf{Real Payment Integration:} Replace COD simulation with Stripe API (test mode initially). Requires implementing webhook handlers for payment confirmation and adding PCI-compliant card input forms.
    
    \item \textbf{MongoDB Transactions:} Wrap order creation and stock deduction in \texttt{session.startTransaction()} to ensure ACID guarantees, eliminating the current race condition risk.
    
    \item \textbf{Email Notifications:} Send order confirmation emails via SendGrid (free tier supports 100 emails/day), improving customer communication without infrastructure costs.
\end{enumerate}
...
\begin{enumerate}
    \item \textbf{Product Reviews:} Allow verified buyers to submit ratings (1-5 stars) and text reviews, with admin moderation dashboard.
    
    \item \textbf{Wishlist System:} Enable users to save products for later, triggering price drop notifications via email (using background jobs with Agenda.js).
    
    \item \textbf{Analytics Dashboard:} Add Chart.js visualizations for admin: sales trends, top products, customer demographics (based on order data).
\end{enumerate}
